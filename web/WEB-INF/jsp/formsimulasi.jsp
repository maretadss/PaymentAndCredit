    ...
    <div class="container">
      <div class="row">
        <div class="align-self-center col-md-6 text-white">
          <h1 class="text-center text-md-left display-3 text-info">Manage Your Money</h1>
          ...
          <div class="card">
            <div class="card-body p-5 bg-info text-muted">
              <h3 class="pb-3">Simulasi Kredit</h3>
                    ...
                    <form:form action="${pageContext.request.contextPath}/simulasi/check" modelAttribute="credit" method="POST" >
                <div class="form-group"> <label>Harga Barang</label>
                  <form:input path="hargaBarang" class="form-control"/> </div>
                <div class="form-group"> <label>Durasi (Dihitung bulan)</label>
