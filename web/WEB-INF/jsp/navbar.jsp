...
<nav class="navbar navbar-expand-md bg-success navbar-dark fixed-top background">
    <div class="container">
        ...
        <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/home"><i class="fa d-inline fa-lg fa-home"></i> Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/payment"><i class="fa d-inline fa-lg fa-black-tie"></i>Pembayaran</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/team"><i class="fa d-inline fa-lg fa-envelope"></i> About Us</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/simulasi"><i class="fa d-inline fa-lg fa-money"></i> Demo</a>
                </li>
            </ul>
        </div>
    </div>
