...
public class CreditBean {
    ...
    public CreditBean(double hargaBarang, double bungaTahunan, int durasi, double uangMuka, double gajiPokok, double bonus, double pendapatanLain, int tanggungan) {
